...
#define VERSION 20 //id for the validation
...
int main () {
    ...
    */
    ...
    char* HASH = "2b4ca190e7db5d29f37c9cb406fb7101d67551ee3171ae5f368558c8a0037c31";
    unsigned char out[l];
    unsigned int u;
    for (i = 0; i < l; ++i) {
